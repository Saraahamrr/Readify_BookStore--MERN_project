...
// Load Stripe
const stripePromise = loadStripe("pk_test_51QpuysRruMS7ZCYMM6M3ZkuWggbceDGTOLzA9n1KOsu5CFt6kkp8Mr4yxd9UmIE4hXUEar5Wxshd2wDXJVMuU0EN003BCuwz0c");
          ...
          <div className="checkout-content">
            <div className="left-section">
              ...
              <form className="checkout-form" onSubmit={handleSubmit}>
                ...
                <input type="text" name="address1" placeholder="Address 1 - City, Street" value={formData.address1} onChange={handleChange} required />
                <input type="text" name="address2" placeholder="Address 2 - Building, Apt, Floor" value={formData.address2} onChange={handleChange} />
                <div className="input-group">
...
<button type="submit" className="pay-btn" disabled={!stripe}>Place Order</button>
